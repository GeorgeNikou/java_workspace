...
public class EditRestaurantController implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		RestaurantBean newRB = new RestaurantBean(view.getTxtfield_name().getText(), view.getTxtfield_address().getText(), view.getDeliveryJList().getModel(), view.getTxtfield_telephone().getText());
