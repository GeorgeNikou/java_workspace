...
public class RestaurantMain {
	...
	public static void main(String[] args) {
		...
		ManagerDashController managerDashController = new ManagerDashController(managerDash, restoCreateMenu, restoEditMenu, restoDeleteMenu);
		...
		MenuBar3RestaurantController menu3Resto= new MenuBar3RestaurantController(loginView,createView,editView,deleteView,restoCreateMenu, restoEditMenu,restoDeleteMenu, adminDash);
		
		MenuBar2MenuController menu2ViewController= new MenuBar2MenuController(createView, editView, deleteView, restoCreateMenu, restoEditMenu,restoDeleteMenu);
		...
		MenuBar3ManagerController menuBar3Manager = new MenuBar3ManagerController(managerDash, restoCreateMenu,  restoEditMenu, restoDeleteMenu );
