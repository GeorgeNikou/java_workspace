...
public class ClientModel {
	...
	public ClientModel() {
		...
		this.createNewClient(new ClientBean("client1", "456", "456", "Amparo", "Jonathan1", "3600 Avenue Du Parc",
				"JonathanAmparo2@live.com", "301-999-6666"), new UserBean("client1", "456", "Client"));
