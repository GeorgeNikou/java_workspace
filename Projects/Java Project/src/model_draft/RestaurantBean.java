...
/*		for(int i = 0; i < this.deliveryArea.getSize(); i++) {
			result = result + "\nDelivery Area: " + this.deliveryArea.getElementAt(i);
		}
		result = result + "\nMonday Opening: " + this.mondayOpenHour + ":" + this.mondayOpenMinute + " - Monday Closing: " + this.mondayCloseHour + ":" + this.mondayCloseMinute +  
				"\nTuesday Opening: " + this.tuesdayOpenHour + ":" + this.tuesdayOpenMinute + " - Tuesday Closing: " + this.tuesdayCloseHour + ":" + this.tuesdayCloseMinute +  
				"\nWednesday Opening: " + this.wednesdayOpenHour + ":" + this.wednesdayOpenMinute + " - Wednesday Closing: " + this.wednesdayCloseHour + ":" + this.wednesdayCloseMinute +  
				"\nThursday Opening: " + this.thursdayOpenHour + ":" + this.thursdayOpenMinute + " - Thursday Closing: " + this.thursdayCloseHour + ":" + this.thursdayCloseMinute +  
				"\nFriday Opening: " + this.fridayOpenHour + ":" + this.fridayOpenMinute + " - Friday Closing: " + this.fridayCloseHour + ":" + this.fridayCloseMinute +  
				"\nSaturday Opening: " + this.saturdayOpenHour + ":" + this.saturdayOpenMinute + " - Saturday Closing: " + this.saturdayCloseHour + ":" + this.saturdayCloseMinute +  
				"\nSunday Opening: " + this.sundayOpenHour + ":" + this.sundayOpenMinute + " - Sunday Closing: " + this.sundayCloseHour + ":" + this.sundayCloseMinute;*/
		return result;
	}
