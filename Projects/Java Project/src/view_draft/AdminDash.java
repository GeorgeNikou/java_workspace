...
public class AdminDash extends JFrame {
	...
	private JButton btnMenuCreate, btnMenuEdit, btnMenuDelete;
	private JButton btnDeliveryDelete, btnDeliveryEdit, btnDeliveryCreate;
	 ...
	 * Runnable() { public void run() { try { AdminDash frame = new AdminDash();
	...
	public AdminDash() {
		...
		btnMenuCreate = new JButton("Create");
		btnMenuCreate.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnMenuCreate.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnMenuCreate.setPreferredSize(new Dimension(150, 50));
		panel_9.add(btnMenuCreate);

		btnMenuEdit = new JButton("Edit");
		btnMenuEdit.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnMenuEdit.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnMenuEdit.setPreferredSize(new Dimension(150, 50));
		panel_9.add(btnMenuEdit);

		btnMenuDelete = new JButton("Delete");
		btnMenuDelete.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnMenuDelete.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnMenuDelete.setPreferredSize(new Dimension(150, 50));
		panel_9.add(btnMenuDelete);
		...
		btnDeliveryCreate = new JButton("Create");
		btnDeliveryCreate.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnDeliveryCreate.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnDeliveryCreate.setPreferredSize(new Dimension(150, 50));
		panel_10.add(btnDeliveryCreate);

		btnDeliveryEdit = new JButton("Edit");
		btnDeliveryEdit.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnDeliveryEdit.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnDeliveryEdit.setPreferredSize(new Dimension(150, 50));
		panel_10.add(btnDeliveryEdit);

		btnDeliveryDelete = new JButton("Delete");
		btnDeliveryDelete.setFont(new Font("Microsoft JhengHei UI Light", Font.PLAIN, 17));
		btnDeliveryDelete.setBorder(new BevelBorder(BevelBorder.RAISED, Color.GRAY, null, Color.GRAY, null));
		btnDeliveryDelete.setPreferredSize(new Dimension(150, 50));
		panel_10.add(btnDeliveryDelete);
	...
	/**
	 * @return the btnMenuCreate
	 */
	public JButton getBtnMenuCreate() {
		return btnMenuCreate;
	}

	/**
	 * @param btnMenuCreate the btnMenuCreate to set
	 */
	public void setBtnMenuCreate(JButton btnMenuCreate) {
		this.btnMenuCreate = btnMenuCreate;
	}

	/**
	 * @return the btnMenuEdit
	 */
	public JButton getBtnMenuEdit() {
		return btnMenuEdit;
	}

	/**
	 * @param btnMenuEdit the btnMenuEdit to set
	 */
	public void setBtnMenuEdit(JButton btnMenuEdit) {
		this.btnMenuEdit = btnMenuEdit;
	}

	/**
	 * @return the btnMenuDelete
	 */
	...
	/**
	 * @param btnMenuDelete the btnMenuDelete to set
	 */
	public void setBtnMenuDelete(JButton btnMenuDelete) {
		this.btnMenuDelete = btnMenuDelete;
	}

	/**
	 * @return the btnDeliveryDelete
	 */
	public JButton getBtnDeliveryDelete() {
		return btnDeliveryDelete;
	}

	/**
	 * @param btnDeliveryDelete the btnDeliveryDelete to set
	 */
	public void setBtnDeliveryDelete(JButton btnDeliveryDelete) {
		this.btnDeliveryDelete = btnDeliveryDelete;
	}

	/**
	 * @return the btnDeliveryEdit
	 */
	public JButton getBtnDeliveryEdit() {
		return btnDeliveryEdit;
	}

	/**
	 * @param btnDeliveryEdit the btnDeliveryEdit to set
	 */
	public void setBtnDeliveryEdit(JButton btnDeliveryEdit) {
		this.btnDeliveryEdit = btnDeliveryEdit;
	}

	/**
	 * @return the btnDeliveryCreate
	 */
	public JButton getBtnDeliveryCreate() {
		return btnDeliveryCreate;
	}

	/**
	 * @param btnDeliveryCreate the btnDeliveryCreate to set
	 */
	public void setBtnDeliveryCreate(JButton btnDeliveryCreate) {
		this.btnDeliveryCreate = btnDeliveryCreate;
	}
