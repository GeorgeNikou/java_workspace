...
public class MenuEditView extends JFrame {
	...
	private JTextField tfItem, tfPrice;

	private JList listEditMenu, listRestaurant;
	private JButton btnEditMenu, btnSelect, btnAddItem, btnEditItem, btnDeleteItem;
...
//	}
	...
	public MenuEditView() {
		...
		btnAddItem.setPreferredSize(new Dimension(115, 29));
		btnAddItem.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(192, 192, 192), null, Color.GRAY, null));
		btnAddItem.setFont(new Font("Arial", Font.BOLD, 15));
		addBtn_panel.add(btnAddItem);
		...
		btnEditMenu.setBorder(new BevelBorder(BevelBorder.RAISED, Color.LIGHT_GRAY, null, Color.GRAY, null));
		btnEditMenu.setPreferredSize(new Dimension(100, 35));
		btnEditMenu.setFont(new Font("Arial", Font.BOLD, 15));
		createBtn_panel.add(btnEditMenu);

		JPanel menuItems_panel = new JPanel();
		right_panel.add(menuItems_panel, BorderLayout.CENTER);

		listEditMenu = new JList();
		listEditMenu.setPreferredSize(new Dimension(375, 375));
		menuItems_panel.add(listEditMenu);
	...
	/**
	 * @return the listEditMenu
	 */
	public JList getListEditMenu() {
		return listEditMenu;
	}

	/**
	 * @param listEditMenu the listEditMenu to set
	 */
	public void setListEditMenu(JList listEditMenu) {
		this.listEditMenu = listEditMenu;
	}
