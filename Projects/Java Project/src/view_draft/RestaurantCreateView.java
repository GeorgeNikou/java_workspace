...
public class RestaurantCreateView extends JFrame {
	...
	// hours
	private JComboBox closingH_comboBox;
	...
	public RestaurantCreateView() {
		...
		closingH_comboBox = new JComboBox();
		closingH_comboBox.setFont(new Font("Arial", Font.PLAIN, 12));
		closingH_comboBox.setPreferredSize(new Dimension(40, 20));
		sunday_panel.add(closingH_comboBox);
	...
	public void setClosingH_comboBox(JComboBox closingH_comboBox) {
		this.closingH_comboBox = closingH_comboBox;
	}
	...
	public void comboResetHour() {
		...
		closingH_comboBox.setSelectedItem(1);
