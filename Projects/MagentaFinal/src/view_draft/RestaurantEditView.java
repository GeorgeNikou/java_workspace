...
public class RestaurantEditView extends JFrame {
	...
	public RestaurantEditView() {
		...
		lblAddRestaurant.setForeground(Color.WHITE);
		...
		deliveryArea_panel.setOpaque(false);
		...
		addRestaurant_panel.setOpaque(false);
		...
		addRestaurantTitle_panel.setOpaque(false);
		...
		addRestaurantList_panel.setOpaque(false);
		...
		deliveryAreaList_panel.setOpaque(false);
		...
		lblH_2.setForeground(Color.WHITE);
		...
		lblH_3.setForeground(Color.WHITE);
		...
		lblTo_3.setForeground(Color.WHITE);
		...
		lblTo_4.setForeground(Color.WHITE);
		...
		lblTo_5.setForeground(Color.WHITE);
		...
		lblTo_6.setForeground(Color.WHITE);
		...
		lblTo_7.setForeground(Color.WHITE);
